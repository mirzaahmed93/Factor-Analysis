---
title: "Factor Analysis shopping exercise"
...
# This creates a realistic dummy dataset
...
# Question: '' The FactorShops data set shows a number of aspects of consumer shopping behaviour in Cardiff, Wales. Using the dataset, critically analyse what factors do consumers find important whe...
...
Specify the variable names (as in your original document) and create a cleaned data matrix for the analysis. Use complete-case rows (na.omit) for the PCA / factor analysis steps below so n used in ...
...
Demonstrate extracting 4 factors and performing varimax rotation using psych::principal...
